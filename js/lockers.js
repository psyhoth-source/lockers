...
function showReservationModal(lockerNumber, lockerName, lockerElement) {
    ...
    form.addEventListener('submit', (e) => {
        ...
        if (targetLocker) {
            ...
            showNotification('success', `Locker #${lockerNumber} reserved for ${duration === 'week' ? '1 week' : duration === 'semester' ? 'semester' : 'academic year'}! The QR code has been sent to your email.`);
        }
        closeModal();
    });
}
